...
WebUI.setText(findTestObject('22_Test/page_purchase_request/Page_Project/Project_information_edit/1-2-2-3project_name'), findTestData(
...
WebUI.setText(findTestObject('22_Test/page_purchase_request/Page_Materials/Materials_Name/1-2-2-3Input_Materials_Name'), findTestData(
        'project_name').getValue(1, 1))
...
WebUI.setText(findTestObject('22_Test/page_purchase_request/Page_Materials/Materials_Arguments/1-2-2-3Input_Materials_Arguments'), 
    '参数')

...
WebUI.click(findTestObject('22_Test/Page_check/shenpiyemian/jingfei_Page/jinfeishiyong'))

WebUI.click(findTestObject('22_Test/Page_check/shenpiyemian/jingfei_Page/jingfei_shenpi_page/jingfei_shenpi_submit_button'))

WebUI.click(findTestObject('22_Test/Page_check/shenpiyemian/jingfei_Page/jingfei_confirm_page/jingfei_confirm_submit_button'))
